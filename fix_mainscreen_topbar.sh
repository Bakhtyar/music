# Fix Search icon and Settings icon
sed -i 's/IconButton(onClick = { \/\* TODO \*\/ }) { Icon(Icons.Filled.Visibility, "Hidden", tint = Color.White) }/IconButton(onClick = { \/\* Settings \*\/ }) { Icon(Icons.Filled.Settings, "Settings", tint = Color.White) }/g' app/src/main/java/com/example/ui/screens/MainScreen.kt

cat << 'INNER_EOF' > modify_mainscreen.py
import sys
